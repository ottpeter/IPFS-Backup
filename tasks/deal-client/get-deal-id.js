...
task(
  ...
  .setAction(async (taskArgs) => {
      ...
      console.log("Getting DealId on network", networkId)
      ...
      let result = await dealClient.getDealId(commPasBytes);                                // Send transaction
      console.log("The dealID is:", result);
  })